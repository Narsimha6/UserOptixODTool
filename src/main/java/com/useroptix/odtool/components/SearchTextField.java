...
public class SearchTextField extends IconTextField implements FocusListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4805953703984416099L;
    ...
    public SearchTextField(Integer size) {
    	super(size);
    	this.textWhenNotFocused = "Search...";
    	this.addFocusListener(this);
    }
    ...
    public void focusGained(FocusEvent e) {
    	if(this.getText() == null || getText().equalsIgnoreCase("Object Type")) {
    		this.repaint();
    	}
    }
